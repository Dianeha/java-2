...
public class StudentStaticApp {
	public static void main(String[] args) {
		...
		*/
		...
		StudentStatic[] studentArray={
				new StudentStatic(1000, "홍길동", 100)
				,new StudentStatic(2000, "임꺽정", 80)
				,new StudentStatic(3000, "전우치", 90)
				,new StudentStatic(4000, "일지매", 70)
				,new StudentStatic(5000, "장길산", 90)};
