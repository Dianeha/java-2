...
//Singleton 디자인 패턴이 적용된 클래스 작성: 싱글톤 클래스
//=> 프로그램에 인스턴스를 하나만 제공하는 클래스
//=> 정보처리 목적의 클래스를 작성할 경우 사용 - manager 클래스
public class SingletonTest {
	//1. 클래스로 생성된 인스턴스 정보를 저장할 목적의 필드 선언 - 정적 필드
	// => 클래스 내부에서만 사용하는 필드 : 시스템 필드 - Getter & Setter 메소드 미선언
	...
	public void select() {
		System.out.println("### 정보를 선택하는 메소드 호출 ###");
	}
